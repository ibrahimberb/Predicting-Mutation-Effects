...
def prepare_data_machine_learning(data, random_seed):
    ...
    # elif study == 'SPMM':
    #     # TODO: Here we remove the heading columns from single protein multiple mutations.
    #     #  the difference is having yet another column called protein_mutation (which stores a tuple values).
